...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Apostador'
        db.delete_table(u'bolao_apostador')

        # Removing M2M table for field boloes on 'Apostador'
        db.delete_table(db.shorten_name(u'bolao_apostador_boloes'))


        # Changing field 'Bolao.admin'
        db.alter_column(u'bolao_bolao', 'admin_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):
        # Adding model 'Apostador'
        db.create_table(u'bolao_apostador', (
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('facebook_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'bolao', ['Apostador'])
        ...
        # Changing field 'Bolao.admin'
        db.alter_column(u'bolao_bolao', 'admin_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bolao.Apostador']))
